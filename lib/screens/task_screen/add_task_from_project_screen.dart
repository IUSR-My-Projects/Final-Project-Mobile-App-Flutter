...
class AddTaskFromProjectScreen extends StatefulWidget {
  final String projectId;

  const AddTaskFromProjectScreen({
    super.key,
...
class _AddTaskFromProjectScreenState extends State<AddTaskFromProjectScreen> {
                  ...
                  onPressed: () {
                    if (_formKey.currentState!.validate()) {
                      ...
                      Provider.of<TaskProvider>(context, listen: false)
                        ..addTask(newTask)
                        ..getTasksByProjectId(widget.projectId);
